...
public class MailApp extends JFrame
{
 ...
 public MailApp()
    ...
    public static void main(String[] args) 
    {
        ...
        app.setSize(800,400);
//        app.mail_label.setVisible(false);
//        app.mail_text.setVisible(false);
//        app.msg_label.setVisible(false);
//        app.msg_text.setVisible(false);
//        app.sub_label.setVisible(false);
//        app.sub_text.setVisible(false);
        app.setVisible(true);
